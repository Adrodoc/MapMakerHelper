//impulse: /give @p spawn_egg 1 0 {display:{Name:"Repulsion Gel Spawner"},EntityTag:{id:"minecraft:chicken",CustomName:"MMH_RepulsionGelSpawner",Silent:1,NoGravity:1}}
//MMH_loadChunks()
